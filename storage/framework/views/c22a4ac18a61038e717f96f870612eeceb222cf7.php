...
<script>
	window.config = {
		...
		"storageURL":"<?php echo e(config('app.cloudinary_enabled') ? '' : '/storage/'); ?>", //URL WHERE YOUR IMAGES and OTHER FILEs stored
		"debug": <?php echo e(env('APP_DEBUG')); ?>
...
<?php /**PATH C:\Voting-System-master\resources\views/index.blade.php ENDPATH**/ ?>